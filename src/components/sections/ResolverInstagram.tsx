...
const ResolverInstagram = () => {
  ...
  return <section className="py-12 sm:py-16 lg:py-20" style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          once: true
            ...
            <Button onClick={handleInstagramClick} className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 text-sm sm:text-base flex items-center gap-2">
          ...
          once: true
            ...
            once: true
              ...
              <button onClick={handleInstagramClick} className="text-orange-400 hover:text-orange-300 font-medium text-sm flex items-center justify-center gap-1 mx-auto transition-colors">
