...
const ResolverContact = () => {
  ...
  return (
    <section id="contato" className="py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Atendimento rápido e direto</p>
            <Button 
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Ligue para nós agora</p>
            <Button 
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Envie sua solicitação</p>
            <Button 
