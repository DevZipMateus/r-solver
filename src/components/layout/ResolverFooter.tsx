          ...
          <div>
            ...
            <div className="space-y-2 sm:space-y-3 text-gray-400 text-sm sm:text-base">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 hover:text-white transition-colors group">
                ...
                <a href="tel:+5545999187722" className="hover:text-orange-500 transition-colors text-xs sm:text-sm">
                  (45) 99918-7722
                </a>
              </div>
              <div className="flex items-center space-x-2 sm:space-x-3 hover:text-white transition-colors group">
                <Mail className="h-4 w-4 text-orange-500 group-hover:scale-110 transition-transform flex-shrink-0" />
                <a href="mailto:rsolver2023@gmail.com" className="hover:text-orange-500 transition-colors text-xs sm:text-sm break-all">
